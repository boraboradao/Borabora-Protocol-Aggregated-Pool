    ...
    ERC20
{
    ...
    function claimLiquidityChange(uint256 requestId) external {
        LiquidityChangeRequest memory request = _liquidityChangeRequest[
            requestId
        ];
        ...
        uint256 totalLPTokenSupplySnapshot = _dailyLiquidityRecord[
            request.dueDate
    ...
    function takeSnapshot(
        ...
        uint256 dueDateAddAmount = _dailyLiquidityRecord[dueDate]
            .accumAddAmount;
        ...
        _dailyLiquidityRecord[dueDate]
            .poolLiquiditySnapshot = fixedPoolLiquidity;
